...
class EvaluationMetric:
    @staticmethod
    def precision_scores(sim_documents, doc_id: str, corpus: Corpus, reverted, ignore_same: bool = False):
        hard_correct = 0
        # soft_correct = 0
        # print(reverted)
    ...
    @staticmethod
    def ap(sim_documents, doc_id: str, corpus: Corpus, reverted, ignore_same: bool = False):
        # print(reverted)
        k = 1
        prec_values_at_k = []
        correct_ones = []
