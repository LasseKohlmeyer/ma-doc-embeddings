...
from flair.embeddings import TransformerDocumentEmbeddings, DocumentPoolEmbeddings, StackedEmbeddings, \
...
from lib2vec.corpus_iterators import FlairDocumentIterator, FlairFacetIterator
